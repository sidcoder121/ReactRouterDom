...
export const RightCardConent = () => {
  return (
       <div className='absolute top-0 left-0 h-full w-full p-8 flex flex-col justify-between'  >
        <h2 className='bg-white text-xl rounded-full h-12 w-12 flex justify-center items-center'>1</h2>
        <div>
            ...
            <div className='flex justify-between'>
                <button className='bg-blue-600 text-white font-semibold px-8 py-3 rounded-full text-lg'>satisfied</button>
